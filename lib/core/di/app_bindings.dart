...
class AppBindings {
  ...
  static Future<void> init() async {
    ...
    Get.put<AppDataRefreshService>(AppDataRefreshService(), permanent: true);
    ...
    Get.put<UsersRepository>(
      UsersRepositoryImpl(Get.find<FirestoreRemoteDataSource>()),
      permanent: true,
    );
    Get.put<CustomersRepository>(
      CustomersRepositoryImpl(Get.find<FirestoreRemoteDataSource>()),
      permanent: true,
    );
    ...
    Get.put<CheckDuplicateMobileUseCase>(CheckDuplicateMobileUseCase(Get.find<CustomersRepository>()), permanent: true);
    Get.put<FindSameNameCustomersUseCase>(FindSameNameCustomersUseCase(Get.find<CustomersRepository>()), permanent: true);
    Get.put<GetCitiesUseCase>(GetCitiesUseCase(Get.find<CustomersRepository>()), permanent: true);
    Get.put<SaveCityUseCase>(SaveCityUseCase(Get.find<CustomersRepository>()), permanent: true);
    Get.put<DeleteCityUseCase>(DeleteCityUseCase(Get.find<CustomersRepository>()), permanent: true);

    // Contacts bulk export (for settings page)
    ...
    Get.put<GetDashboardSummaryUseCase>(
      GetDashboardSummaryUseCase(Get.find<CustomersRepository>()),
      permanent: true,
    );
